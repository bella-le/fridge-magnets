...
'bird', 'but', 'but', 'by', 'by', 'bye', 'calm', 'celebrate', 'chaos', 'child', 'children', 'cloud', 'cold', 'coffee', 'comet',
...
'hello', 'hi', 'huge', 'huh', 'huh', 'hungry', 'I', 'I', 'if', 'if', 'in', 'in', 'in', 'ing', 'ing', 'ing',
'ing', 'ing', 'ing', 'ing', 'ing', 'is', 'is', 'it', 'it', 'its', 'its', 'jellyfish', 'juice', 'kazoo', 'ketchup', 'kumquat', 'lasagna',
